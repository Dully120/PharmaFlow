        ...
        <div class="col-md-9">
            <div class="content-card">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                    <h4 class="mb-0"><i class="fas fa-tags"></i> الفئات</h4>
                    <div class="search-control-row">
                        ...
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addCategoryModal"><i class="fas fa-plus"></i> جديد</button>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover" id="categoriesTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $categoryModel->countProducts($c['id']) ?></td>
                                <td class="text-nowrap">
                                    <button class="btn btn-sm btn-warning" onclick="openEditModal(<?= $c['id'] ?>, '<?= addslashes($c['name']) ?>', '<?= addslashes($c['description']) ?>')"><i class="fas fa-edit"></i></button>
                                    <a href="index.php?controller=admin&action=categoryDelete&id=<?= $c['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('هل أنت متأكد من حذف هذه الفئة؟')"><i class="fas fa-trash"></i></a>
                                 </td
                              ?>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus"></i> إضافة فئة جديدة</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="POST" action="index.php?controller=admin&action=categoryCreate">
...
<div class="modal fade" id="editCategoryModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-edit"></i> تعديل فئة</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
function openEditModal(id, name, description) {
    ...
    document.getElementById('editCategoryForm').action = 'index.php?controller=admin&action=categoryEdit&id=' + id;
